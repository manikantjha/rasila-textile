...
export default function NavDrawer(props: INavDrawerNavDrawer) {
  return (
    <div className="fixed top-[60] left-0 right-0 h-[calc(100vh_-_60px)] z-[1000] p-4 overflow-y-auto bg-white w-full shadow-lg transition-all grid grid-rows-[auto_1fr] gap-4">
      <button
        type="button"
        className="text-gray-400 bg-gray-200 hover:bg-gray-200 hover:text-gray-900 rounded-full text-sm p-1.5 w-fit ml-auto inline-flex items-center"
      ...
      <ul className="flex flex-col p-4 border border-gray-200 space-y-4">
