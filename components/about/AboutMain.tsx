...
export default function AboutMain() {
  return (
    <>
      <Hero
        imgSrc="https://images.unsplash.com/photo-1476683874822-744764a2438f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
        hasContent={true}
        title="About"
        imgAlt=""
